  ...
  return (
    <div className="space-y-6 animate-in fade-in duration-500 pb-12">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          <h2 className="text-2xl font-black text-gray-800 dark:text-white tracking-tight">التقارير والإحصائيات</h2>
          <p className="text-sm text-gray-400 font-medium mt-1">تحليل مفصل لأداء المنصة، المبيعات، وحركة الشحن</p>
        </div>
